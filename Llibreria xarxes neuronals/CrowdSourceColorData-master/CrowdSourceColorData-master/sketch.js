...
function setup() {
  ...
  var config = {
    apiKey: "AIzaSyB7QJsYciTumDYW21vzCGMNBc5q7SD3SjU",
    authDomain: "pelis-ff496.firebaseapp.com",
    databaseURL: "https://pelis-ff496.firebaseio.com",
    projectId: "pelis-ff496",
    storageBucket: "pelis-ff496.appspot.com",
    messagingSenderId: "551850179041"
  };
  ...
  buttons.push(createButton('Clar').parent('#root').class('red-ish'));
  buttons.push(createButton('Fosc').parent('#root').class('green-ish'));
